...
import wandb
class UNet_DA_Pixelwise(tf.keras.Model):
    ...
    It also implements Domain Adaptation through a reversal gradient block.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(UNet_DA_Pixelwise, self).__init__(**kwargs)
        ...
        self.train_writer = tf.summary.create_file_writer("/home/amarinai/DeepLearningThesis/Results/Unet_DA1/UNet_tensorboard/train")
    ...
    def call(self, inputs, training=True):
        ...
        if training == True:
            domain_pred = self.domain_classifier(h, training=training)
    ...
    def get_config(
        ...
        config = super(UNet_DA_Pixelwise, self).get_config()
        config.update(
            {
...
if __name__ == "__main__":
    unet = UNet_DA_Pixelwise(4, 32, 3, 2)
