...
import wandb
class UNetSkipHead_2(tf.keras.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(UNetSkipHead_2, self).__init__(**kwargs)
    ...
    def call(self, inputs, training=True):
        ...
        if training == True:
            domain_pred = self.domain_classifier(h_pred, training=training)
    ...
    def get_config(
        ...
        config = super(UNetSkipHead_2, self).get_config()
        config.update(
            {
