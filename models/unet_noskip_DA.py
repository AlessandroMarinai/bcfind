...
import wandb
class UNetNoSkip_DA(tf.keras.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        super(UNetNoSkip_DA, self).__init__(**kwargs)
    ...
    def call(self, inputs, training=True):
        ...
        if training == True:
            domain_pred = self.domain_classifier(encodings[-1], training=training)
    ...
    def get_config(
        ...
        config = super(UNetNoSkip_DA, self).get_config()
        config.update(
            {
