...
from data import TrainingDataset_DA, TrainingDataset, TrainingDataset_DA_gamma, TrainingDataset_DA_slice
from losses import FramedCrossentropy3D
from metrics import Precision, Recall, F1
from models import UNetNoSkip_DA, UNet_DA_Pixelwise, UNetSkipHead, UNetSkipHead_2, UNetSkipHead_3, UNetSkipHead_4, ResUNet_DA
...
class Trainer:
    ...
    def make_unet_data_DA(               
        ...
        **preprocessing_kwargs,
        ...
        self.unet_train_data = TrainingDataset_DA_slice(
            tiff_list=train_inputs,
            marker_list=train_targets,
            tiff_ome_path=tiff_ome_path,
        ...
        if val_inputs and val_targets:
            self.unet_val_data = TrainingDataset_DA_slice(
    ...
    def build_unet(
        ...
        self.unet.build((None, 50, 100, 100, 1)) #define the dimensions
        ...
        for epoch in range(epochs):
            ...
            for step, data in enumerate(self.unet_train_data):
                ...
                with tf.GradientTape() as tape:
                    ...
                    bce_loss = self.bce(y_pred=y_domain, y_true=gt_domain)*0.005
    ...
    def run(
        self, config_file, only_dog=False, test_as_val=None, use_lmdb=False, gpu=0, checkpoint=False,
    ):
        """
        ...
        if not only_dog:
            ...
            if test_as_val:
                self.make_unet_data_DA(
                    ...
                    tiff_ome_path = conf.target_unlabeled.basepath,
